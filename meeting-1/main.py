...
test_text_embs = test_text_embs.cpu().numpy()
...
plot_tsne(test_image_embs, test_labels, "meeting-1/image-tsne", title="t-SNE for Image Embeddings")
plot_tsne(test_text_embs, test_labels, "meeting-1/text-tsne", title="t-SNE for Text Embeddings")
