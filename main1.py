...
plot_tsne(image_embeddings, "tsne_image.png", all_labels, title="t-SNE for Image Embeddings")
plot_tsne(text_embeddings, "tsne_text.png", all_labels, title="t-SNE for Text Embeddings")